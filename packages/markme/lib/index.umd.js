...
var click = function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(opt, ele, popover, evt) {
...
function _fill2() {
  ...
  chunks.forEach(function (chunk, i) {
    domList[i] && _fill(_extends$1({ color: color, id: id, words: words }, chunk), domList[i], opt);
  });
}
